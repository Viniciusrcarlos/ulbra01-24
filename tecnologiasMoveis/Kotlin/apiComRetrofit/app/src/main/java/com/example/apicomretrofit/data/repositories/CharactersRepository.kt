...
class CharactersRepository @Inject constructor(private val dataSource: CharactersDataSource) {

    suspend fun fetchCharacters(): List<Character> {
        return dataSource.fetchCharacters().charactersResult.map { item -> item.toModel() }
    }
}